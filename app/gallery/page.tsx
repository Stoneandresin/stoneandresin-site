...
export const metadata = {
  ...
  description:
    "Browse our resin-bound driveway, patio, and pool deck installations in Cincinnati and Amelia, OH. Before & after photos of Vuba system installs with UV-stable finishes.",
  openGraph: {
    title: "Resin-Bound Project Gallery | Stone & Resin",
    description:
      "See real before & after photos of our resin-bound installations across Greater Cincinnati. UV-stable, permeable surfaces that last.",
    type: "website",
