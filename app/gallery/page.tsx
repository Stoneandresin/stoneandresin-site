...
export default async function Page() {
  // Always use local gallery images - consistent DOM structure regardless of Cloudinary config
    ...
    <main>
      <div className="bg-slate-900 pt-32 pb-12">
        <div className="mx-auto max-w-6xl px-6">
          <h1 className="text-4xl font-serif text-white mb-4">Project Gallery</h1>
          <p className="text-xl text-white/80 max-w-2xl">
            See real before & after photos of our resin-bound installations across Greater Cincinnati.
          </p>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-6xl p-6">
        ...
        <section className="space-y-6">
          ...
          {localPhotos.length === 0 ? (
            <p className="text-gray-500 italic">No gallery photos found.</p>
          ) : (
